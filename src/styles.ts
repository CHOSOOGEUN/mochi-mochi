...
const styles = StyleSheet.create({
  ...
  levelBar: { position: 'absolute', top: SCREEN_H * 0.06, left: 20, backgroundColor: 'rgba(255,249,240,0.9)', paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20, borderWidth: 2, borderColor: '#E0D0C0', shadowColor: '#B0948A', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 8, alignItems: 'center', gap: 4 },
  levelText: { fontSize: 13, fontWeight: '900', color: '#4A3F35' },
  xpBarBg: { width: 60, height: 5, backgroundColor: '#EAD5C2', borderRadius: 3, overflow: 'hidden' },
  xpBarFill: { height: '100%', backgroundColor: '#C85070', borderRadius: 3 },
  ...
  skinCard: { width: (SCREEN_W - 52) / 2, backgroundColor: '#FFF9F0', borderRadius: 20, paddingHorizontal: 14, paddingBottom: 14, paddingTop: 10, alignItems: 'center', borderWidth: 2, borderColor: '#E8D8C8', gap: 8, shadowColor: '#B0948A', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 8 },
  skinCardSelected: { borderColor: '#7BA870', borderWidth: 3 },
  skinPreviewWrap: { width: 110, height: 110, justifyContent: 'center', alignItems: 'center', overflow: 'visible' as any },
  skinPreview: { width: 82, height: 82, borderRadius: 41, borderWidth: 3, justifyContent: 'center', alignItems: 'center', overflow: 'visible', shadowColor: '#B0948A', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 10 },
  skinPreviewBlush: { position: 'absolute', top: '38%', width: 16, height: 10, borderRadius: 6, opacity: 0.65 },
  skinPreviewEyes: { flexDirection: 'row', gap: 14, marginTop: -4 },
  skinPreviewEye: { width: 8, height: 11, backgroundColor: '#4A3F35', borderRadius: 4 },
  skinPreviewMouth: { fontSize: 10, color: '#C4907A', fontWeight: '600', marginTop: -2 },
