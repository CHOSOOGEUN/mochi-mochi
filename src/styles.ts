...
const styles = StyleSheet.create({
  ...
  skinCard: { width: (SCREEN_W - 52) / 2, backgroundColor: '#FFF9F0', borderRadius: 20, paddingHorizontal: 14, paddingBottom: 14, paddingTop: 20, alignItems: 'center', borderWidth: 2, borderColor: '#E8D8C8', gap: 8, shadowColor: '#B0948A', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 8 },
  skinCardSelected: { borderColor: '#7BA870', borderWidth: 3 },
  skinPreviewWrap: { width: 90, height: 90, justifyContent: 'center', alignItems: 'center' },
